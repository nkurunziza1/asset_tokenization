...
const LoginButton = dynamic(() => import("./utils/loginButton"), {ssr:false})
      ...
      >
        <nav>
          <header className="py-4">
            <div className="w-full flex h-16 items-center justify-between gap-8 px-4 sm:px-6 lg:px-8">
              <img src="/logo2-removebg-preview.png" alt="" width={200}  />
